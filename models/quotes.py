...
#     )  # Store features as a string or JSON

#     # Relationship with DogInsurance
#     dog_insurances = db.relationship(
#         "DogInsurance", backref="insurance_plan", lazy=True
#     )


# class DogInsurance(db.Model):
...
#         db.Integer, db.ForeignKey("insurance_plans.id"), nullable=False
#     )  # FK to insurance plans

#     # Relationship with Pet and InsurancePlan
#     pet = db.relationship("Pet", backref="insurance_plans", lazy=True)
#     insurance_plan = db.relationship(
#         "InsurancePlan", backref="pet_insurances", lazy=True
#     )
